 ...
 *
 * This file defines the interface that the {{pascalCase operation_name}}Controller must conform to.  This helps the Typescript
 ...
 */
interface I{{pascalCase operation_name}}Controller {
...
export { I{{pascalCase operation_name}}Controller }
